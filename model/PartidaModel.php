...
class PartidaModel
{
    ...
    public function incrementarPuntaje($id_partida)
    {
    ...
    public function incrementarPreguntaRespondidaCorrectamente($id_partida)
    {
    ...
    public function registrarPreguntaRespondida($id_partida, $id_pregunta, $id_respuesta, $acerto)
    {
